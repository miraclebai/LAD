...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, validation=None, test=None, predict=None,
        ...
        super().__init__()
        # ========= 这里是新加的 START =========
        # 兼容老版本和新版本 Lightning 对 DataModule 的内部标记
        # 老版本：_has_setup_fit / _has_setup_validate / ...
        self._has_setup_fit = False
        self._has_setup_validate = False
        self._has_setup_test = False
        self._has_setup_predict = False

        # 新版本：会构造 "_has_setup_{fn}"，fn 是 TrainerFn 枚举，比如 TrainerFn.FITTING
        # 因为 attr 会变成字符串 "_has_setup_TrainerFn.FITTING"，我们先把所有都置 False
        for fn in TrainerFn:
            setattr(self, f"_has_setup_{fn}", False)
        # ========= 这里是新加的 END =========
